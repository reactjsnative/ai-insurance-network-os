// TikTok Ads tutorial video generator — NOT available on Vercel.
//
...
export default function handler(_req, res) {
  return res.status(501).json({
    ok: false,
    error: 'ฟีเจอร์สร้างวิดีโอต้องใช้ Python + ffmpeg ซึ่ง Vercel ไม่รองรับ — รันบนเครื่องของคุณด้วยคำสั่ง `npm run dev` เพื่อสร้างวิดีโอสอนยิงแอดได้',
  });
}
