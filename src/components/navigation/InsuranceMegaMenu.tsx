...
export default function InsuranceMegaMenu() {
  ...
  return (
    <header ref={ref} className="relative z-50 border-b border-sky-100/60 bg-sky-50">
      ...
      {desktopOpen && (
        <>
          ...
          <section className="absolute left-1/2 top-[76px] z-50 hidden w-[min(94vw,1200px)] -translate-x-1/2 overflow-hidden rounded-2xl border border-sky-100/60 bg-sky-50 shadow-2xl lg:block">
            <div className="grid min-h-[480px] grid-cols-[300px_1fr]">
              <aside className="border-r border-sky-100/60 bg-sky-50 p-6">
              ...
              <main className="p-7 bg-sky-50">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {active.links.map(l=>{
                    const Icon=l.icon;
                    return (
                      <button key={l.tab} onClick={()=>go(l.tab)} className="group flex gap-3 rounded-xl border border-sky-100/60 bg-sky-50 p-4 text-left transition hover:border-blue-600/40 hover:bg-sky-50">
        ...
        <div className="fixed inset-0 z-[70] bg-sky-50 lg:hidden">
          ...
          <div className="h-[calc(100vh-68px)] overflow-y-auto p-5 space-y-3">
            {categories.map(c=>{
              ...
              return (
                <div key={c.id} className="overflow-hidden rounded-xl border border-sky-100/60 bg-sky-50">
                  ...
                  {exp && (
                    <div className="space-y-2 border-t border-sky-100/60 bg-sky-50 p-3">
                      {c.links.map(l=>{
                        const Ic=l.icon;
                        return (
                          <button key={l.tab} onClick={()=>go(l.tab)} className="flex w-full gap-3 rounded-lg bg-sky-50 p-3 text-left border border-sky-100/60">
