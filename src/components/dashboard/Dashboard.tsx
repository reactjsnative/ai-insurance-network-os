...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div id="executive_dashboard_view" className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 sm:p-4 rounded-2xl bg-sky-50/80 border border-sky-100/60 backdrop-blur-md shadow-xl">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-50 via-sky-100 to-indigo-950/40 border border-sky-100/60 p-6 sm:p-8 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="max-w-xl text-left space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-sky-100/80 hover:bg-sky-100 text-slate-800 font-semibold text-xs sm:text-sm border border-sky-100/60 flex items-center gap-2 transition-all"
              >
          ...
          <div className="relative w-full lg:w-96 h-72 rounded-2xl bg-sky-50/60 border border-sky-100/60/80 p-4 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-sky-50/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-blue-600/40 transition-colors">
        ...
        {/* KPI 2: Total FYC */}
        <div className="p-5 rounded-2xl bg-sky-50/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-sky-500/40 transition-colors">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-2xl bg-sky-50/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-emerald-500/40 transition-colors">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-2xl bg-sky-50/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-purple-500/40 transition-colors">
          <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-5 sm:p-6 rounded-2xl bg-sky-50/90 border border-sky-100/60 text-left">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-sky-50/90 border border-sky-100/60 text-left flex flex-col justify-between">
          <div>
      ...
      <div className="p-5 sm:p-6 rounded-2xl bg-sky-50/90 border border-sky-100/60 text-left">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {incomeResult.breakdown.slice(0, 6).map((item) => (
            <div key={item.id} className="p-3 rounded-xl bg-sky-50/70 border border-sky-100/60/80">
      ...
      <div className="p-4 rounded-xl bg-sky-50/50 border border-sky-100/60/60 text-left text-[11px] text-slate-700 leading-relaxed">
