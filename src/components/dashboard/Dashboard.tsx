...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div id="executive_dashboard_view" className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 sm:p-4 rounded-2xl bg-[#f0f9ff]/80 border border-sky-100/60 backdrop-blur-md shadow-xl">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-50 via-sky-100 to-indigo-950/40 border border-sky-100/60 p-6 sm:p-8 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="max-w-xl text-left space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-bold text-xs sm:text-sm shadow-sm shadow-amber-500/20 flex items-center gap-2 transition-transform hover:scale-105 active:scale-95"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-[#e0f2fe]/80 hover:bg-[#e0f2fe] text-slate-800 font-semibold text-xs sm:text-sm border border-sky-100/60 flex items-center gap-2 transition-all"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-indigo-600/80 hover:bg-indigo-600 text-slate-900 font-semibold text-xs sm:text-sm border border-indigo-500/50 flex items-center gap-2 shadow-sm shadow-indigo-600/20 transition-all"
              >
          ...
          <div className="relative w-full lg:w-96 h-72 rounded-2xl bg-[#f0f9ff]/60 border border-sky-100/60/80 p-4 flex flex-col items-center justify-center overflow-hidden">
            ...
            {animationStep >= 2 && (
              <div className="absolute inset-0 flex items-center justify-around px-2 pointer-events-none">
                {centerLeaders.map((cm, idx) => (
                  ...
                  >
                    <div className="w-9 h-9 rounded-full overflow-hidden border border-blue-400/80 shadow-sm">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-blue-600/40 transition-colors">
        ...
        {/* KPI 2: Total FYC */}
        <div className="p-5 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-sky-500/40 transition-colors">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-800">{t('kpi_team_fyc')}</span>
            <div className="w-8 h-8 rounded-xl bg-[#f0f9ff]0/10 text-sky-400 flex items-center justify-center">
        ...
        <div className="p-5 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-emerald-500/40 transition-colors">
          <div className="flex items-center justify-between">
        ...
        <div className="p-5 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 relative overflow-hidden text-left group hover:border-purple-500/40 transition-colors">
          <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-5 sm:p-6 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 text-left">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 text-left flex flex-col justify-between">
          <div>
          ...
          <button
            ...
            className="w-full mt-4 py-2 rounded-xl bg-[#e0f2fe] hover:bg-slate-200 text-slate-800 text-xs font-semibold flex items-center justify-center gap-1 transition-colors"
          >
      ...
      <div className="p-5 sm:p-6 rounded-2xl bg-[#f0f9ff]/90 border border-sky-100/60 text-left">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          {incomeResult.breakdown.slice(0, 6).map((item) => (
            <div key={item.id} className="p-3 rounded-xl bg-[#f0f9ff]/70 border border-sky-100/60/80">
      ...
      <div className="p-4 rounded-xl bg-[#f0f9ff]/50 border border-sky-100/60/60 text-left text-[11px] text-slate-800 leading-relaxed">
