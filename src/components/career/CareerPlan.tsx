    ...
    <div id="career_plan_view" className="space-y-8 max-w-7xl mx-auto pb-16 text-left">
      ...
      <section className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div className="p-5 rounded-2xl bg-gradient-to-br from-sky-50 to-fuchsia-950/20 border border-sky-100 space-y-4">
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-br from-sky-50 to-amber-950/20 border border-sky-100 space-y-4">
      ...
      <section className="space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-sky-50/60 border border-sky-100 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-2xl bg-sky-50/60 border border-sky-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
            {forecast.map((s) => {
              ...
              return (
                <div key={s.key} className="p-3 rounded-xl bg-sky-50/60 border border-sky-100">
                  <div className="flex items-center gap-2">
...
const NumberField: React.FC<{
  ...
  <div className="p-4 rounded-2xl bg-sky-50/60 border border-sky-100 space-y-1.5">
    ...
    <input
      ...
      className="w-full bg-sky-50 border border-sky-100 rounded-lg px-3 py-2 text-sm text-slate-900 focus:outline-none focus:border-blue-600"
    />
  </div>
);
...
const KpiCard: React.FC<{ label: string; value: string; sub: string; accent: 'sky' | 'violet' | 'emerald' | 'amber' }> = ({ label, value, sub, accent }) => {
  ...
  return (
    <div className={`p-4 rounded-2xl bg-gradient-to-br to-sky-50 border border-sky-100 ${ring}`}>
...
const InfiniteNetworkTree: React.FC<{
  ...
  return (
    <div className="p-5 rounded-2xl bg-gradient-to-br from-sky-50 to-rose-950/10 border border-sky-100 space-y-4">
      {/* Toolbar */}
      ...
      <div className="relative rounded-2xl bg-sky-50/70 border border-sky-100 p-4 overflow-x-auto">
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex flex-col items-center p-2 rounded-xl border bg-sky-50/80 transition-all hover:-translate-y-0.5 ${
                        isSel ? `${role.ring} ring-2 ring-rose-400/40` : 'border-sky-100 hover:border-slate-600'
                      }`}
                      title={`${n.name} • ${role.label}`}
                    >
                      <span
                        className="absolute -top-1.5 -right-1.5 w-3 h-3 rounded-full border border-sky-100"
