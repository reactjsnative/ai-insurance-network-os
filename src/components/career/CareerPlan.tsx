  ...
  return (
    <div id="career_plan_view" className="space-y-8 max-w-7xl mx-auto pb-16 text-left">
      ...
      <section className="space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-white/60 border border-slate-200 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-2xl bg-white/60 border border-slate-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
            {forecast.map((s) => {
              ...
              return (
                <div key={s.key} className="p-3 rounded-xl bg-white/60 border border-slate-200">
                  <div className="flex items-center gap-2">
...
const InfiniteNetworkTree: React.FC<{
  ...
  return (
    <div className="p-5 rounded-2xl bg-gradient-to-br from-white to-rose-950/10 border border-slate-200 space-y-4">
      ...
      <div className="relative rounded-2xl bg-white/70 border border-slate-200 p-4 overflow-x-auto">
                ...
                {layer.nodes.map((n) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative flex flex-col items-center p-2 rounded-xl border bg-white/80 transition-all hover:-translate-y-0.5 ${
                        isSel ? `${role.ring} ring-2 ring-rose-400/40` : 'border-slate-200 hover:border-slate-600'
                      }`}
