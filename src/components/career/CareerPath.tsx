  ...
  return (
    <div id="career_path_view" className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-br from-sky-50 to-indigo-950/40 border border-sky-50/40 flex flex-col justify-between">
          <div>
          ...
          <div className="space-y-3 mt-6 pt-4 border-t border-sky-50/40">
        ...
        <div className="lg:col-span-2 p-6 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="h-3 w-full rounded-full bg-[#fcfdff] overflow-hidden border border-sky-50/40">
      ...
      <div className="p-6 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-4">
        <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-4 rounded-2xl bg-[#fcfdff] border border-sky-50/40 space-y-2">
