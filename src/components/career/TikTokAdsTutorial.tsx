...
export const TikTokAdsTutorial: React.FC = () => {
  ...
  return (
    <div id="tiktok_ads_view" className="space-y-8 max-w-7xl mx-auto pb-16 text-left">
      {/* Header */}
      <div className="p-6 rounded-3xl bg-gradient-to-r from-sky-50 to-rose-950/30 border border-sky-50/40 shadow-[0_4px_12px_rgba(148,163,184,0.10)] flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {DEFAULT_SCENES.map((s, i) => (
          <div key={i} className="p-4 rounded-2xl bg-[#fcfdff]/70 border border-sky-50/40">
      ...
      <section className="space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-gradient-to-br from-sky-50 to-rose-950/20 border border-sky-50/40 space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              onClick={buildVideo}
              disabled={loading}
              className="px-5 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-400 hover:to-pink-400 text-slate-900 text-xs font-bold shadow-[0_1px_3px_rgba(148,163,184,0.08)] shadow-rose-500/20 transition-all disabled:opacity-60 flex items-center gap-2"
            >
              {loading ? (
                <>
          ...
          {videoUrl && (
            <div className="rounded-2xl overflow-hidden border border-rose-500/30 bg-[#fcfdff]">
              <video
                src={videoUrl}
                controls
