    ...
    <div id="recruitment_portal_container" className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 border border-indigo-500/20 p-6 sm:p-8 shadow-xl">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-2 bg-white/80 p-1.5 rounded-xl border border-slate-200 self-start md:self-auto">
            <button
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none focus:border-indigo-500"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.firstName ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.lastName ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2.5 text-sm text-slate-800 font-mono focus:outline-none ${
                        validationErrors.nationalId ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-white border rounded-lg pl-9 pr-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                          validationErrors.phone ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                        }`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-white border rounded-lg pl-9 pr-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                          validationErrors.email ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                        }`}
                      />
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.university ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.currentOccupation ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
              ...
              <div className="space-y-6 animate-fadeIn">
                    ...
                    <>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2.5 text-sm text-slate-800 font-mono focus:outline-none focus:border-indigo-500"
                        />
                ...
                <div className="pt-4 border-t border-slate-200/80">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label className="flex items-center gap-3 p-3.5 rounded-xl bg-white border border-slate-200 cursor-pointer hover:border-slate-200">
                      <input
                        type="checkbox"
                        checked={formData.hasICLicense}
                        onChange={(e) => setFormData({ ...formData, hasICLicense: e.target.checked })}
                        className="w-4 h-4 rounded text-indigo-600 focus:ring-indigo-500 bg-white border-slate-200"
                      />
                      <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-white border rounded-lg px-3 py-2 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.motivationNote ? 'border-rose-500' : 'border-slate-200 focus:border-indigo-500'
                      }`}
                    />
            ...
            <div className="pt-6 border-t border-slate-200 flex items-center justify-between">
              {currentStep > 1 ? (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-slate-100 text-slate-700 text-xs font-semibold hover:bg-slate-200 transition-all"
                >
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-lg pl-9 pr-4 py-2 text-sm text-slate-800 focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <select
                ...
                className="bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none focus:border-indigo-500"
              >
                      ...
                      <tr key={app.id} className="hover:bg-slate-100/30 transition-colors">
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2.5">
                            <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center font-bold text-xs text-slate-800 border border-slate-200">
      ...
      {selectedApplication && (
        <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-white border border-slate-200 rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl animate-scaleUp max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
      ...
      {submissionSuccessModal && (
        <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-emerald-500/40 rounded-2xl max-w-md w-full p-6 text-center space-y-4 shadow-2xl animate-scaleUp">
            ...
            <div className="p-3 bg-white rounded-xl border border-slate-200 text-xs font-mono text-indigo-400 font-bold">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-slate-100 text-slate-700 text-xs font-semibold hover:bg-slate-200 transition-all"
              >
