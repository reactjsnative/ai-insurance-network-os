    ...
    <div id="recruitment_portal_container" className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#f0f9ff] via-[#e0f2fe] to-[#bae6fd]/30 border border-sky-100 p-6 sm:p-8 shadow-xl">
          ...
          <div className="flex items-center gap-2 bg-[#f0f9ff] p-1.5 rounded-xl border border-sky-100/80 shadow-sm self-start md:self-auto">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold transition-all ${
                activeSubTab === 'form'
                  ? 'bg-blue-600 text-white shadow-sm shadow-indigo-600/30'
                  : 'text-slate-800 hover:text-blue-700 hover:bg-[#f0f9ff]'
              }`}
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-6 border-t border-sky-100">
          <div className="bg-[#f0f9ff] p-3 rounded-xl border border-sky-100/60 shadow-sm">
      ...
      {activeSubTab === 'form' && (
        <div className="bg-[#f0f9ff] border border-sky-100/80/80 rounded-2xl p-6 sm:p-8 shadow-xl">
          {/* Step Progress Tracker */}
          <div className="mb-8">
            <div className="flex items-center justify-between relative">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-[#e0f2fe] w-full -z-0" />
              <div 
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 relative z-10 bg-[#f0f9ff] px-3 py-1 rounded-xl transition-all ${
                      isCurrent ? 'scale-105' : ''
                    }`}
                  >
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all ${
                      isPassed 
                        ...
                        : 'bg-[#e0f2fe] border-sky-100 text-slate-800'
                    }`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none focus:border-indigo-500"
                    >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.firstName ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.lastName ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 font-mono focus:outline-none ${
                        validationErrors.nationalId ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-[#f0f9ff] border rounded-lg pl-9 pr-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                          validationErrors.phone ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                        }`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-[#f0f9ff] border rounded-lg pl-9 pr-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                          validationErrors.email ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                        }`}
                      />
                    </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.university ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.currentOccupation ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
              ...
              <div className="space-y-6 animate-fadeIn">
                        ...
                        <div
                          ...
                          className={`p-4 rounded-xl border cursor-pointer transition-all ${
                            formData.licenseStatus === item.id
                              ...
                              : 'bg-[#f0f9ff] border-sky-100 text-slate-800 hover:border-sky-100'
                          }`}
                        >
                    ...
                    <>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg px-3 py-2.5 text-sm text-slate-800 font-mono focus:outline-none focus:border-indigo-500"
                        />
                ...
                <div className="pt-4 border-t border-sky-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label className="flex items-center gap-3 p-3.5 rounded-xl bg-[#f0f9ff] border border-sky-100/80 cursor-pointer hover:border-sky-100">
                      <input
                        type="checkbox"
                        checked={formData.hasICLicense}
                        onChange={(e) => setFormData({ ...formData, hasICLicense: e.target.checked })}
                        className="w-4 h-4 rounded text-indigo-600 focus:ring-indigo-500 bg-[#f0f9ff] border-sky-100"
                      />
                      <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg px-3 py-2 text-sm text-blue-600 font-bold focus:outline-none focus:border-blue-600"
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg px-3 py-2 text-sm text-emerald-700 font-bold focus:outline-none focus:border-emerald-500"
                      />
                      <p className="text-[11px] text-slate-800 mt-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-[#f0f9ff] border rounded-lg px-3 py-2 text-sm text-slate-800 focus:outline-none ${
                        validationErrors.motivationNote ? 'border-rose-500' : 'border-sky-100 focus:border-indigo-500'
                      }`}
                    />
            ...
            <div className="pt-6 border-t border-sky-100 flex items-center justify-between">
              {currentStep > 1 ? (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-sky-100 bg-[#e0f2fe] text-slate-800 text-xs font-semibold hover:bg-slate-200 transition-all"
                >
              ...
              {currentStep < 4 ? (
                <button
                  ...
                  className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-blue-600 text-white text-xs font-semibold hover:bg-indigo-500 shadow-sm shadow-indigo-600/30 transition-all"
                >
                ...
                <button
                  type="submit"
                  className="flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-slate-900 text-sm font-bold hover:from-emerald-500 hover:to-teal-500 shadow-xl shadow-emerald-600/30 transition-all"
                >
      ...
      {activeSubTab === 'list' && (
        <div className="space-y-4">
          {/* Filter Bar */}
          <div className="bg-[#f0f9ff] border border-sky-100/80 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg pl-9 pr-4 py-2 text-sm text-slate-800 focus:outline-none focus:border-indigo-500"
              />
            </div>
            ...
            <div className="flex items-center gap-3 w-full sm:w-auto">
              ...
              <select
                ...
                className="bg-[#f0f9ff] border border-sky-100/80 rounded-lg px-3 py-2 text-xs text-slate-800 focus:outline-none focus:border-indigo-500"
              >
          ...
          {/* Applications Table */}
          <div className="bg-[#f0f9ff] border border-sky-100/80 rounded-xl overflow-hidden shadow-xl">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-sm">
                <thead className="bg-[#f0f9ff] text-slate-800 uppercase text-[10px] font-bold border-b border-sky-100 tracking-wider">
                  <tr>
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {filteredApps.length === 0 ? (
                    ...
                    filteredApps.map((app) => (
                      <tr key={app.id} className="hover:bg-[#e0f2fe]/30 transition-colors">
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2.5">
                            <div className="w-8 h-8 rounded-full bg-[#e0f2fe] flex items-center justify-center font-bold text-xs text-slate-800 border border-sky-100">
      ...
      {activeSubTab === 'stats' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#f0f9ff] border border-sky-100/80/80 rounded-2xl p-6 shadow-xl space-y-4">
          ...
          <div className="bg-[#f0f9ff] border border-sky-100/80/80 rounded-2xl p-6 shadow-xl space-y-4">
            ...
            <div className="p-4 rounded-xl bg-[#f0f9ff] border border-sky-100/80 space-y-3 text-xs">
      ...
      {selectedApplication && (
        <div className="fixed inset-0 bg-[#f0f9ff]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-[#f0f9ff] border border-sky-100/80/80 rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl animate-scaleUp max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="p-3.5 rounded-xl bg-[#f0f9ff] border border-sky-100/80 space-y-1.5">
              ...
              <div className="sm:col-span-2 p-3.5 rounded-xl bg-[#f0f9ff] border border-sky-100/80 space-y-1.5">
                ...
                <p className="text-slate-800 mt-2 italic bg-[#f0f9ff] p-2.5 rounded-lg border border-sky-100">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full bg-[#f0f9ff] border border-sky-100/80 rounded-lg p-2.5 text-xs text-slate-800 focus:outline-none focus:border-indigo-500"
              />
            </div>

            {/* Modal Actions */}
            <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-sky-100">
              <button
                type="button"
                onClick={() => setSelectedApplication(null)}
                className="px-4 py-2 rounded-xl text-xs font-semibold text-slate-800 hover:text-slate-900 bg-[#e0f2fe]"
              >
                ...
                {selectedApplication.status !== 'approved' && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-5 py-2 rounded-xl text-xs font-bold bg-emerald-600 text-slate-900 hover:bg-emerald-500 shadow-sm shadow-emerald-600/30 transition-all"
                    >
      ...
      {submissionSuccessModal && (
        <div className="fixed inset-0 bg-[#f0f9ff]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#f0f9ff] border border-emerald-500/40 rounded-2xl max-w-md w-full p-6 text-center space-y-4 shadow-2xl animate-scaleUp">
            ...
            <div className="p-3 bg-[#f0f9ff] rounded-xl border border-sky-100 text-xs font-mono text-indigo-700 font-bold">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-[#e0f2fe] text-slate-800 text-xs font-semibold hover:bg-slate-200 transition-all"
              >
