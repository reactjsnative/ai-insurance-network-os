    ...
    <div id="recruitment_portal_container" className="space-y-6 max-w-7xl mx-auto pb-12">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold transition-all ${
                activeSubTab === 'form'
                  ...
                  : 'text-slate-800 hover:text-blue-700 hover:bg-sky-50'
              }`}
            >
        ...
        <div className="bg-white border border-sky-100/80/80 rounded-2xl p-6 sm:p-8 shadow-xl">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between relative">
              <div className="absolute left-0 top-1/2 -translate-y-1/2 h-0.5 bg-sky-100 w-full -z-0" />
              <div 
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 relative z-10 bg-white px-3 py-1 rounded-xl transition-all ${
                      isCurrent ? 'scale-105' : ''
                    }`}
                  >
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center border-2 transition-all ${
                      isPassed 
                        ...
                        : 'bg-sky-100 border-sky-100 text-slate-800'
                    }`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f8fbff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-[#f8fbff] border rounded-lg px-3 py-2.5 text-sm text-slate-800 font-mono focus:outline-none ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full bg-[#f8fbff] border rounded-lg pl-9 pr-3 py-2.5 text-sm text-slate-800 focus:outline-none ${
                        ...
                        <div
                          ...
                          className={`p-4 rounded-xl border cursor-pointer transition-all ${
                            formData.licenseStatus === item.id
                              ...
                              : 'bg-[#f8fbff] border-sky-100 text-slate-800 hover:border-sky-100'
                          }`}
                        >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <label className="flex items-center gap-3 p-3.5 rounded-xl bg-white border border-sky-100/80 cursor-pointer hover:border-sky-100">
                      <input
                        ...
                        className="w-4 h-4 rounded text-indigo-600 focus:ring-indigo-500 bg-[#f8fbff] border-sky-100"
                      />
                      <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full bg-[#f8fbff] border rounded-lg px-3 py-2 text-sm text-slate-800 focus:outline-none ${
            ...
            <div className="pt-6 border-t border-sky-100 flex items-center justify-between">
              {currentStep > 1 ? (
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl border border-sky-100 bg-sky-100 text-slate-800 text-xs font-semibold hover:bg-slate-200 transition-all"
                >
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {filteredApps.length === 0 ? (
                    ...
                    filteredApps.map((app) => (
                      <tr key={app.id} className="hover:bg-sky-100/30 transition-colors">
                        ...
                        <td className="px-4 py-3.5">
                          <div className="flex items-center gap-2.5">
                            <div className="w-8 h-8 rounded-full bg-sky-100 flex items-center justify-center font-bold text-xs text-slate-800 border border-sky-100">
          ...
          <div className="bg-white border border-sky-100/80/80 rounded-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 shadow-2xl animate-scaleUp max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="sm:col-span-2 p-3.5 rounded-xl bg-white border border-sky-100/80 space-y-1.5">
                ...
                <p className="text-slate-800 mt-2 italic bg-sky-50 p-2.5 rounded-lg border border-sky-100">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-4 border-t border-sky-100">
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-semibold text-slate-800 hover:text-slate-900 bg-sky-100"
              >
      ...
      {submissionSuccessModal && (
        <div className="fixed inset-0 bg-sky-50/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#f8fbff] border border-emerald-500/40 rounded-2xl max-w-md w-full p-6 text-center space-y-4 shadow-2xl animate-scaleUp">
            ...
            <div className="p-3 bg-sky-50 rounded-xl border border-sky-100 text-xs font-mono text-indigo-700 font-bold">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-sky-100 text-slate-800 text-xs font-semibold hover:bg-slate-200 transition-all"
              >
