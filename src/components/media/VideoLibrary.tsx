    ...
    <div id="video_library_view" className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-3">
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden bg-white border border-slate-200">
            {activeVideo ? (
        ...
        <div className="space-y-2">
          <h3 className="text-sm font-bold text-slate-700 px-1">รายการวีดีโอ ({videos.length})</h3>
