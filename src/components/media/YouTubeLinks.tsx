    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {links.map((l) => (
          <div
            key={l.id}
            className="group relative p-4 rounded-2xl bg-gradient-to-br from-sky-50/90 to-sky-50 border border-sky-50/40 hover:border-red-500/40 transition-all"
          >
            ...
            <button
              ...
              className="mt-3 w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-[#f0f9ff] hover:bg-red-500/20 hover:text-red-300 text-slate-800 text-xs font-semibold border border-sky-50/40 transition-all"
            >
