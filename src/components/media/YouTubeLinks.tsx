        ...
        {links.map((l) => (
          ...
          >
            ...
            <button
              ...
              className="mt-3 w-full flex items-center justify-center gap-2 py-2 rounded-lg bg-[#e0f2fe] hover:bg-red-500/20 hover:text-red-300 text-slate-800 text-xs font-semibold border border-sky-100/60 transition-all"
            >
