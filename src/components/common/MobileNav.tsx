...
export const MobileNav: React.FC = () => {
  ...
  return (
    <div id="mobile_bottom_nav" className="lg:hidden fixed bottom-0 left-0 right-0 h-16 bg-[#f0f9ff]/95 backdrop-blur-md border-t border-sky-100/60 z-40 px-2 flex items-center justify-around">
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 py-1 transition-all ${
              isActive ? 'text-blue-600' : 'text-slate-800 hover:text-slate-800'
            }`}
          >
