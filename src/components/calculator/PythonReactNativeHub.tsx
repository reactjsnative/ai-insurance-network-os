...
const MobileSimulatorView: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-[#fcfdff] text-slate-900 font-sans space-y-4 text-left rounded-3xl border border-sky-50/40 shadow-[0_4px_12px_rgba(148,163,184,0.10)]">
      {/* Header */}
      ...
      {/* Position Tabs */}
      <div className="grid grid-cols-4 gap-1 p-1 bg-[#fcfdff] rounded-xl border border-sky-50/40">
        {[
      ...
      {/* Inputs */}
      <div className="p-3.5 rounded-2xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-2.5">
        ...
        <div className="flex items-center justify-between text-xs">
          ...
          <input
            ...
            className="w-24 bg-[#fcfdff] border border-sky-50/40 rounded-lg px-2 py-1 text-right text-xs text-blue-600 font-bold"
          />
        </div>
        ...
        {position !== 'agent' && (
          <div className="flex items-center justify-between text-xs">
            ...
            <input
              ...
              className="w-24 bg-[#fcfdff] border border-sky-50/40 rounded-lg px-2 py-1 text-right text-xs text-sky-400 font-bold"
            />
          </div>
        )}
        ...
        {position === 'region_manager' && (
          <div className="flex items-center justify-between text-xs">
            ...
            <input
              ...
              className="w-24 bg-[#fcfdff] border border-sky-50/40 rounded-lg px-2 py-1 text-right text-xs text-rose-400 font-bold"
            />
          </div>
        )}
        ...
        {position !== 'agent' && (
          <div className="flex items-center justify-between text-xs">
            ...
            <input
              ...
              className="w-20 bg-[#fcfdff] border border-sky-50/40 rounded-lg px-2 py-1 text-right text-xs text-emerald-400 font-bold"
            />
          </div>
        )}
      </div>
      ...
      <div className="space-y-2">
        ...
        {calc.items.map((it) => (
          <div key={it.id} className="p-2.5 rounded-xl bg-[#fcfdff]/80 border border-sky-50/40 flex items-center justify-between">
            <div>
...
export const PythonReactNativeHub: React.FC = () => {
  return (
    <div className="space-y-6 text-left">
      {/* Header Hero Card */}
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-amber-500/15 via-sky-100 to-indigo-950/40 border border-blue-600/30 shadow-[0_4px_12px_rgba(148,163,184,0.10)]">
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 rounded-2xl bg-[#fcfdff]/60 border border-sky-50/40 flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Sheet 1: ภาพรวม */}
          <div className="p-5 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-extrabold text-blue-600 uppercase tracking-wider">แผ่นที่ 1 / ภาพรวม</span>
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#f0f9ff] text-slate-800 font-mono">โครงสร้าง & คุณสมบัติ</span>
            </div>
            <h3 className="text-base font-bold text-slate-900">โครงสร้างรายได้ และคุณสมบัติการแต่งตั้ง 4 ตำแหน่ง</h3>

            <div className="space-y-2 text-xs text-slate-800">
              <div className="p-3 rounded-xl bg-[#fcfdff] border border-sky-50/40/80 space-y-1">
          ...
          <div className="p-5 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#f0f9ff] text-slate-800 font-mono">UM Rules</span>
            </div>
          ...
          <div className="p-5 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#f0f9ff] text-slate-800 font-mono">CM Rules</span>
            </div>
          ...
          <div className="p-5 rounded-3xl bg-[#fcfdff]/90 border border-sky-50/40 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#f0f9ff] text-slate-800 font-mono">RM Rules</span>
            </div>
