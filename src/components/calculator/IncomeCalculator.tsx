...
export const IncomeCalculator: React.FC = () => {
  ...
  return (
    <div id="income_calculator_view" className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl bg-sky-50/90 border border-sky-100/60 shadow-xl">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-sky-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold border border-sky-100/60 flex items-center gap-1.5 transition-colors"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-3 rounded-xl bg-sky-50 border border-sky-100/60">
              ...
              <select
                ...
                className="w-full bg-sky-50 border border-sky-100/60 rounded-lg px-2 py-1 text-xs text-slate-800 focus:outline-none"
              >
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-amber-500/10 via-sky-100 to-indigo-950/40 border border-blue-600/30 p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="p-3 rounded-2xl bg-sky-50/80 border border-sky-100/60">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-sky-100 text-slate-700 border border-sky-100/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {incomeResult.breakdown.map((item) => (
            <div
              ...
              className="p-4 rounded-2xl bg-sky-50/80 hover:bg-sky-50 border border-sky-100/60 hover:border-blue-600/50 cursor-pointer transition-all duration-200 group flex flex-col justify-between"
            >
              <div>
              ...
              <div className="pt-3 mt-3 border-t border-sky-100/60/80 flex items-center justify-between text-[10px] text-slate-700">
      ...
      {selectedIncomeCard && (
        <div className="fixed inset-0 bg-sky-50/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-sky-50 border border-sky-100/60 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in duration-200">
      ...
      {showTestModal && (
        <div className="fixed inset-0 bg-sky-50/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-sky-50 border border-sky-100/60 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-sky-100/60">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              {testResults.map((t, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-sky-50 border border-sky-100/60 flex items-center justify-between text-xs">
                  <div>
