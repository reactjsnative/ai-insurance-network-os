...
export const IncomeCalculator: React.FC = () => {
  ...
  return (
    <div id="income_calculator_view" className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl bg-white/90 border border-slate-200 shadow-xl">
        <div>
      ...
      {calcMode !== 'ACTUAL' && (
        <div className="p-5 sm:p-6 rounded-2xl bg-white/60 border border-purple-500/30 space-y-4">
      ...
      {showTestModal && (
        <div className="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-slate-200">
              <div className="flex items-center gap-2">
