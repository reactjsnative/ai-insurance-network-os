...
export const IncomeCalculator: React.FC = () => {
  ...
  const getPositionBadge = (posId: string) => {
    switch (posId) {
      ...
      default: return { label: 'ตัวแทน (Agent)', bg: 'bg-[#f0f9ff]0/20 text-sky-300 border-sky-500/40' };
    }
  };
  ...
  return (
    <div id="income_calculator_view" className="space-y-6 max-w-7xl mx-auto pb-16 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-3xl bg-[#f0f9ff]/90 border border-sky-100/60 shadow-xl">
        <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="inline-flex p-1 rounded-xl bg-[#f0f9ff] border border-sky-100/60">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                calcMode === 'ACTUAL' 
                  ? 'bg-blue-600 text-slate-950 shadow-sm shadow-amber-500/20' 
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                calcMode === 'PROJECTED' 
                  ? 'bg-[#f0f9ff]0 text-slate-950 shadow-sm shadow-sky-500/20' 
                  : 'text-slate-800 hover:text-slate-800'
              }`}
            >
              PROJECTED (คาดการณ์)
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-[#e0f2fe] hover:bg-slate-200 text-slate-800 text-xs font-semibold border border-sky-100/60 flex items-center gap-1.5 transition-colors"
          >
      ...
      {calcMode !== 'ACTUAL' && (
        <div className="p-5 sm:p-6 rounded-2xl bg-[#f0f9ff]/60 border border-purple-500/30 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Personal COM */}
            <div className="p-3 rounded-xl bg-[#f0f9ff] border border-sky-100/60">
            ...
            <div className="p-3 rounded-xl bg-[#f0f9ff] border border-sky-100/60">
              ...
              <select
                ...
                className="w-full bg-[#f0f9ff] border border-sky-100/60 rounded-lg px-2 py-1 text-xs text-slate-800 focus:outline-none"
              >
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-amber-500/10 via-sky-100 to-indigo-950/40 border border-blue-600/30 p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="p-3 rounded-2xl bg-[#f0f9ff]/80 border border-sky-100/60">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold px-2 py-0.5 rounded-full bg-[#e0f2fe] text-slate-800 border border-sky-100/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {incomeResult.breakdown.map((item) => (
            <div
              ...
              className="p-4 rounded-2xl bg-[#f0f9ff]/80 hover:bg-[#f0f9ff] border border-sky-100/60 hover:border-blue-600/50 cursor-pointer transition-all duration-200 group flex flex-col justify-between"
            >
              <div>
                <div className="flex items-start justify-between gap-2">
                  ...
                  <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${
                    item.amount > 0 ? 'bg-emerald-500/10 text-emerald-300 border border-emerald-500/30' : 'bg-[#e0f2fe] text-slate-800'
                  }`}>
              ...
              <div className="pt-3 mt-3 border-t border-sky-100/60/80 flex items-center justify-between text-[10px] text-slate-800">
      ...
      {selectedIncomeCard && (
        <div className="fixed inset-0 bg-[#f0f9ff]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#f0f9ff] border border-sky-100/60 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="flex items-center justify-between pb-3 border-b border-sky-100/60">
              ...
              <button
                ...
                className="w-7 h-7 rounded-lg bg-[#e0f2fe] text-slate-800 hover:text-slate-900 flex items-center justify-center text-xs"
              >
                ✕
              </button>
            </div>
            ...
            <button
              onClick={() => setSelectedIncomeCard(null)}
              className="w-full py-2.5 rounded-xl bg-[#e0f2fe] hover:bg-slate-200 text-slate-800 text-xs font-bold transition-colors"
            >
              ปิดหน้าต่าง
            </button>
          </div>
      ...
      {showTestModal && (
        <div className="fixed inset-0 bg-[#f0f9ff]/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#f0f9ff] border border-sky-100/60 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="flex items-center justify-between pb-3 border-b border-sky-100/60">
              <div className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              {testResults.map((t, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-[#f0f9ff] border border-sky-100/60 flex items-center justify-between text-xs">
                  <div>
