        ...
        {authOAuthProvider === 'google' && (
          <div className="p-6">
            ...
            <div className="py-5 text-center">
              ...
              <p className="text-xs text-slate-800 mt-1">to continue to <span className="font-semibold text-indigo-600">AI Insurance Network OS</span></p>
            </div>
          ...
          <div className="p-6 bg-[#fcfdff] text-slate-900">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                disabled={isProcessing}
                onClick={closeOAuthPopup}
                className="w-full py-2.5 px-4 rounded-xl text-slate-800 hover:text-slate-900 text-xs transition-colors"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                disabled={isProcessing}
                onClick={closeOAuthPopup}
                className="w-full py-2.5 px-4 rounded-xl text-slate-800 hover:text-slate-800 text-xs transition-colors"
              >
                Cancel
              </button>
            </div>
