    ...
    <div id="welcome-login-gateway-screen" className="min-h-screen bg-sky-50 text-slate-900 flex flex-col justify-between selection:bg-blue-600 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <header className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-between relative z-10">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 flex items-center justify-center shadow-lg shadow-amber-500/20 text-slate-950 font-black text-xl shrink-0">
            OS
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-sky-50/90 hover:bg-sky-100 text-blue-600 border border-sky-100 text-xs font-bold transition-all shadow-sm cursor-pointer"
          >
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center flex-1 relative z-10">
        ...
        <div className="lg:col-span-5">
          <motion.div 
            ...
            className="p-6 sm:p-8 rounded-3xl bg-sky-50 border border-sky-100 shadow-2xl space-y-6 relative overflow-hidden backdrop-blur-xl"
          >
            {/* Top Card Branding */}
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                type="button"
                className="w-full py-2.5 px-4 rounded-xl bg-sky-50 hover:bg-sky-100 text-slate-900 font-bold text-xs shadow-sm transition-all flex items-center justify-center gap-3 border border-sky-100 cursor-pointer active:scale-[0.99]"
              >
              ...
              <button
                ...
                type="button"
                className="w-full py-2.5 px-4 rounded-xl bg-sky-50 hover:bg-zinc-900 text-white font-bold text-xs shadow-sm transition-all flex items-center justify-center gap-3 border border-zinc-800 cursor-pointer active:scale-[0.99]"
              >
              ...
              <button
                ...
                type="button"
                className="w-full py-2.5 px-4 rounded-xl bg-sky-50 hover:bg-sky-50 text-white font-bold text-xs shadow-sm transition-all flex items-center justify-center gap-3 border border-sky-100 cursor-pointer active:scale-[0.99]"
              >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-sky-50 border border-sky-100 focus:border-blue-600 rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full bg-sky-50 border border-sky-100 focus:border-blue-600 rounded-xl pl-10 pr-10 py-2.5 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-xs">
                <label className="flex items-center gap-2 text-slate-700 cursor-pointer">
                  <input
                    ...
                    className="rounded border-sky-100 bg-sky-50 text-blue-600 focus:ring-blue-500 w-3.5 h-3.5"
                  />
            ...
            <div className="pt-4 border-t border-sky-100 text-center space-y-2">
      ...
      <footer className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 border-t border-sky-100 text-center text-xs text-slate-700 relative z-10">
        {t('login_copyright')}
      </footer>
    </div>
  );
