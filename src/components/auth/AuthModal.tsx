  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg bg-sky-50 rounded-3xl shadow-2xl border border-sky-100/80 overflow-hidden my-8"
      >
        {/* Header Bar */}
        <div className="relative bg-gradient-to-r from-sky-50 via-indigo-950 to-slate-50 text-white p-6 sm:p-7">
          <button
          ...
          {/* Tab navigation */}
          <div className="flex items-center gap-2 mt-5 p-1 bg-sky-100/80 rounded-xl border border-sky-100/60">
            <button
              id="tab-btn-login"
              onClick={() => {
                setErrorMessage('');
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-3.5 rounded-xl border border-sky-100 hover:border-indigo-300 bg-sky-50 hover:bg-sky-50/80 text-slate-700 font-semibold text-xs transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-3.5 rounded-xl border border-sky-100 bg-sky-50 hover:bg-zinc-900 text-white font-semibold text-xs transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-3.5 rounded-xl border border-sky-100 bg-sky-50 hover:bg-sky-50 text-white font-semibold text-xs transition-all shadow-sm flex items-center justify-center gap-2 cursor-pointer"
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 text-xs text-slate-800 outline-none transition-all"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 text-xs text-slate-800 outline-none transition-all"
                    />
                    <button
                      type="button"
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3.5 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 text-xs text-slate-800 outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 text-xs text-slate-800 outline-none uppercase"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 text-xs text-slate-800 outline-none bg-sky-50"
                >
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="000000"
                      className="w-full px-3.5 py-3 rounded-xl border border-sky-100 focus:border-indigo-500 text-center text-xl tracking-[0.5em] font-bold text-slate-800 outline-none font-mono"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-10 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 text-xs text-slate-800 outline-none"
                      />
                      <button
                        type="button"
                ...
                <form onSubmit={handleVerifyCode} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-sky-100 focus:border-indigo-500 text-xs text-slate-800 outline-none font-mono"
                    />
