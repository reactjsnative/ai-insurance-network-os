      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-slate-300 font-semibold block mb-1">รหัสสมาชิก</label>
              <input
                type="text"
                required
                value={code}
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">ชื่อเล่น</label>
              <input
                type="text"
                value={nickname}
          ...
          <div>
            <label className="text-slate-300 font-semibold block mb-1">ชื่อ-นามสกุล</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-slate-300 font-semibold block mb-1">ระดับตำแหน่ง</label>
              <select
                value={position}
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">หัวหน้าสายงาน (Parent)</label>
              <select
                value={parentId}
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              <label className="text-slate-300 font-semibold block mb-1">ยอดขาย / ด. (บาท)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">COM ส่วนตัว (บาท)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">FYC ส่วนตัว (บาท)</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-slate-300 font-semibold block mb-1">พอร์ตเบี้ยปีต่อไป (บาท)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">เป้าหมายรายได้ (บาท/ด)</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-slate-300 font-semibold block mb-1">จำนวนหน่วยแยก (หน่วย)</label>
              <input
                type="number"
            ...
            <div>
              <label className="text-slate-300 font-semibold block mb-1">จำนวนศูนย์แยก (ศูนย์)</label>
              <input
                type="number"
