    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#fcfdff]/75 backdrop-blur-sm">
      <div className="bg-[#fcfdff] border border-sky-50/40 rounded-2xl w-full max-w-lg shadow-[0_8px_24px_rgba(148,163,184,0.08)] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#f0f9ff] border border-sky-50/40 rounded-xl px-3 py-2 text-slate-900 focus:outline-none"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full bg-[#f0f9ff] border border-sky-50/40 rounded-xl px-3 py-2 text-slate-900 focus:outline-none cursor-pointer"
              >
          ...
          {/* Footer actions */}
          <div className="flex items-center justify-between pt-4 border-t border-sky-50/40">
            <button
              type="button"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                className="flex items-center gap-1.5 px-5 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white text-xs font-bold shadow-[0_1px_3px_rgba(148,163,184,0.08)] shadow-blue-500/20 cursor-pointer"
              >
