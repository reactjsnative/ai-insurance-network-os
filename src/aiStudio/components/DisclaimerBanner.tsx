...
export const DisclaimerBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-amber-950/90 via-amber-900/60 to-slate-50 border-b border-amber-600/40 text-amber-100 text-xs px-4 py-2.5 shadow-[0_1px_3px_rgba(148,163,184,0.08)]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-2">
        <div className="flex items-center gap-2.5 flex-1">
          ...
          <div className="flex-1">
            ...
            <span className="text-amber-200/90 font-medium">
              ...
              <span className="text-blue-600 font-bold underline decoration-amber-400 underline-offset-2">
        ...
        <div className="flex items-center gap-2 self-end md:self-auto shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-0.5 rounded text-blue-600 hover:bg-amber-800/40 transition-colors cursor-pointer text-[11px]"
          >
