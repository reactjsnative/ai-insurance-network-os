...
export const DisclaimerBanner: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-amber-950/90 via-amber-900/60 to-slate-900 border-b border-amber-600/40 text-amber-100 text-xs px-4 py-2.5 shadow-md">
