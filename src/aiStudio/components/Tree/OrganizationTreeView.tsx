...
const TreeNodeComponent: React.FC<TreeNodeProps> = ({
  ...
  let borderClass = 'border-sky-100 hover:border-slate-500';
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <div className="flex items-center justify-between mt-2.5 pt-2 border-t border-sky-100 text-[10px]">
        ...
        {/* Sales & Rollup Stats */}
        <div className="mt-2.5 grid grid-cols-2 gap-1.5 text-[11px] bg-sky-50/60 p-2 rounded-xl border border-sky-100/80">
          <div>
          ...
          <div className="col-span-2 pt-1 border-t border-sky-100/60 flex items-center justify-between">
        ...
        {children.length > 0 && (
          <button
            ...
            className="w-full mt-2.5 py-1 px-2 rounded-lg bg-sky-100/80 hover:bg-slate-200/80 text-[11px] font-semibold text-slate-700 flex items-center justify-center gap-1 border border-sky-100 transition-colors"
          >
            {isExpanded ? (
              <>
...
export const OrganizationTreeView: React.FC = () => {
  ...
  return (
    <div className="space-y-4 pb-12">
      ...
      {/* Controls Bar */}
      <div className="bg-sky-50/90 border border-sky-100 rounded-2xl p-4 shadow-xl flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5 flex-1">
          <div className="relative flex-1 min-w-[200px] max-w-sm">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 rounded-xl bg-sky-100 border border-sky-100 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500"
            />
          </div>
          ...
          <select
            ...
            className="bg-sky-100 border border-sky-100 text-xs text-slate-800 rounded-xl px-3 py-1.5 focus:outline-none cursor-pointer"
          >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex items-center bg-sky-100 rounded-xl p-1 border border-sky-100">
            <button
          ...
          <button
            onClick={expandAll}
            className="px-2.5 py-1.5 rounded-xl bg-sky-100 hover:bg-slate-200 border border-sky-100 text-xs text-slate-800 transition-colors cursor-pointer"
          >
            กางทั้งหมด
          </button>
          <button
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 text-xs text-slate-700 bg-sky-50/60 p-3 rounded-xl border border-sky-100">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-sky-100 text-slate-700 border border-sky-100 text-[11px] font-semibold">
      ...
      <div className="bg-sky-50 border border-sky-100 rounded-2xl p-8 shadow-2xl overflow-auto min-h-[600px]">
        <div
