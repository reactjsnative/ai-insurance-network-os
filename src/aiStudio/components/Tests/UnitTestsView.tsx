    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-lg flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-slate-400">ชุดทดสอบทั้งหมด</span>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-lg flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-slate-400">ผ่านเกณฑ์ (Passed)</span>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-lg flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-slate-400">ไม่ผ่าน (Failed)</span>
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 shadow-lg flex items-center gap-3">
          ...
          <div>
            <span className="text-xs text-slate-400">อัตราความถูกต้อง</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex bg-slate-800 rounded-xl p-1 border border-slate-700 text-xs">
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg font-semibold transition-colors cursor-pointer ${
                filter === 'PASSED' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-white'
              }`}
            >
              ผ่าน ({passedCount})
            </button>
